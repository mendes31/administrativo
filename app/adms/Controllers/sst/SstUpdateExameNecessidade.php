...
class SstUpdateExameNecessidade
{
    private array $data = [];
  ...
  array (
    ...
    4 => 'periodicidade_meses',
        ...
        $pageElements = [
            'title_head' => 'Update Necessidade de Exame - SST',
            'menu' => 'sst-list-exame-necessidade',
            'buttonPermission' => ['SstUpdateExameNecessidade'],
        ];
    ...
    private function update(int $id): void
    {
        ...
        if ($repo->update($id, $data)) {
            ...
            $_SESSION['msg_type'] = 'danger';
            header('Location: ' . $_ENV['URL_ADM'] . 'sst-update-exame-necessidade/' . $id);
        }
        exit;
    }
}
