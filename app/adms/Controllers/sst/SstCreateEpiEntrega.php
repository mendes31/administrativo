...
class SstCreateEpiEntrega
{
  ...
  array (
    ...
    4 => 'data_movimento',
        ...
        $pageElements = [
            'title_head' => 'Create Entrega de EPI - SST',
            'menu' => 'sst-list-epi-entregas',
            'buttonPermission' => ['SstCreateEpiEntrega'],
        ];
    ...
    private function create(): void
    {
        ...
        if ($newId) {
            ...
            header('Location: ' . $_ENV['URL_ADM'] . 'sst-view-epi-entrega/' . $newId);
        } else {
            $_SESSION['msg'] = 'Erro ao salvar registro.';
            $_SESSION['msg_type'] = 'danger';
            header('Location: ' . $_ENV['URL_ADM'] . 'sst-create-epi-entrega');
        }
        exit;
    }
}
