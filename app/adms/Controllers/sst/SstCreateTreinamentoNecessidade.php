...
class SstCreateTreinamentoNecessidade
{
    private array $data = [];
    ...
    public function index(): void
    {
        ...
        $pageElements = [
            'title_head' => 'Nova Necessidade de Treinamento SST',
            'menu' => 'sst-list-treinamento-necessidade',
            'buttonPermission' => ['SstCreateTreinamentoNecessidade'],
        ];
    ...
    private function create(): void
    {
        ...
        if ((new SstTreinamentoNecessidadeRepository())->create($data)) {
            ...
            $_SESSION['msg_type'] = 'danger';
            header('Location: ' . $_ENV['URL_ADM'] . 'sst-create-treinamento-necessidade');
        }
        exit;
    }
}
