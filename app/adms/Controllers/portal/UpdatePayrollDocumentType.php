...
class UpdatePayrollDocumentType
{
    ...
    private function update(int $id): void
    {
        ...
        $payload = [
            ...
            'signature_reminders_enabled' => isset($_POST['signature_reminders_enabled']) && $_POST['signature_reminders_enabled'] === '1',
            'signature_reminder_day_1' => max(0, min(365, (int)($_POST['signature_reminder_day_1'] ?? 1))),
            'signature_reminder_day_2' => max(0, min(365, (int)($_POST['signature_reminder_day_2'] ?? 3))),
            'signature_reminder_day_3' => max(0, min(365, (int)($_POST['signature_reminder_day_3'] ?? 7))),
