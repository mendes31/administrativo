...
function gerenciarParcelas(string $num_doc, string $card_code_fornecedor, array $novasParcelas): void {
...
// Redireciona para list-payments usando flash (sem popup nativo).
