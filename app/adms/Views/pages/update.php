        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-text">Primeiro segmento da URL em kebab-case minúsculo.</div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="form-text">Pasta sob <code>Controllers/</code>, mesma caixa do disco (Linux).</div>
                </div>
