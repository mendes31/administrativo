        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-text">Nome da classe em PascalCase, igual ao arquivo em <code>app/adms/Controllers/{diretório}/</code>.</div>
                </div>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-text">Primeiro segmento da URL em kebab-case minúsculo (sem o pacote <code>/administrativo/</code>).</div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="form-text">Pasta sob <code>Controllers/</code>, com a mesma caixa do disco (Linux: sensível a maiúsculas/minúsculas).</div>
                </div>
