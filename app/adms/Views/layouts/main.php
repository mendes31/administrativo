...
<body class="sb-nav-fixed">
    ...
    <script src="<?php echo htmlspecialchars($pushSessionSyncInit['urlAdm'], ENT_QUOTES, 'UTF-8'); ?>/public/adms/js/pwa-app.js?v=1"></script>
    <?php endif; ?>
    ...
    <div id="pwaUpdateBanner" class="d-none position-fixed bottom-0 start-0 end-0 p-3" style="z-index: 1080;">
        <div class="alert alert-primary shadow mb-0 d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2 gap-sm-3 mx-auto" style="max-width: 42rem;">
            <div class="flex-grow-1 small">
                <i class="fas fa-sync-alt me-1"></i>
                <strong>Nova versão do aplicativo</strong> disponível.
            </div>
            <div class="d-flex gap-2 flex-shrink-0">
                <button type="button" class="btn btn-sm btn-outline-primary" id="btnPwaUpdateLater">Depois</button>
                <button type="button" class="btn btn-sm btn-primary" id="btnPwaUpdateNow">Atualizar agora</button>
            </div>
        </div>
    </div>
    <?php endif; ?>
