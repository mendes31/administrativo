...
<div class="card mb-4 border-light shadow">
  ...
  <div class="card-body">
    ...
    <form method="POST" class="row g-3">
      ...
      <div class="col-12"><p class="form-text mb-0">Campos <strong>R$/min</strong> são referência do cadastro (exibidos na rota consolidada). Custeio oficial: rateio CFIX (crit. 3 HM); energia CVAR usa <strong>kW</strong>.</p></div>
