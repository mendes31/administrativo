...
window.projectCategoryIds = projectCategoryIds;
...
<?php
$bomScriptListBomItems = $this->data['listBomItems'] ?? [];
$bomScriptListUnits = $this->data['listUnits'] ?? [];
$bomScriptIsProjectItem = (bool)($this->data['is_project_item'] ?? false);
include __DIR__ . '/../partials/bom_edit_scripts.php';
?>
<script>
