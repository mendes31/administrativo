...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form method="post">
            <input type="hidden" name="csrf_token" value="<?= \App\adms\Helpers\CSRFHelper::generateCSRFToken('form_create_inventory_adjust') ?>">
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    <label class="form-label">Estoque origem (quando reduzir)</label>
                    <select class="form-select" name="from_stock_id" data-stock-select data-target-position="from_position_id">
                ...
                <div class="col-md-4">
                    <label class="form-label">Estoque destino (quando aumentar)</label>
                    <select class="form-select" name="to_stock_id" data-stock-select data-target-position="to_position_id">
                        <option value="">Selecione...</option>
                        <?php foreach (($this->data['listStocks'] ?? []) as $s): ?>
                            <option value="<?= $s['id'] ?>"><?= htmlspecialchars($s['name']) ?></option>
                        <?php endforeach; ?>
            ...
            <template id="mov-item-row">
                <div class="row mov-item g-2 align-items-end mb-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" step="0.0001" class="form-control" name="items[][qty]" required />
                    </div>
                    <div class="col-md-2">
                        <label class="form-label">Custo (quando +)</label>
