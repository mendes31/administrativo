...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header"><span><i class="fas fa-user-graduate me-2"></i>Novo Plano de Desenvolvimento</span></div>
        <div class="card-body">
            <?php include './app/adms/Views/partials/alerts.php'; ?>
            <form action="" method="POST" class="row g-3">
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_create_pdi_plan'); ?>">
                ...
                <div class="col-12 d-flex gap-2">
                    ...
                    <a href="<?php echo $_ENV['URL_ADM']; ?>list-pdi-plans" class="btn btn-secondary">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
