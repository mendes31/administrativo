    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6 text-end">
            <a href="<?php echo $_ENV['URL_ADM']; ?>export-relatorio-informativo-pdf?informativo_id=<?php echo $this->data['informativo']['id']; ?>"
               ...
               onclick="event.preventDefault(); const q=(typeof getRelatorioInformativoUserFilterValue === 'function') ? getRelatorioInformativoUserFilterValue() : ''; const href=this.getAttribute('href'); if (q) { window.location.href = href + '&usuario_filter=' + encodeURIComponent(q); } else { window.location.href = href; }">
