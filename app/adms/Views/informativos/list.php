...
function showImageModal(url) {
    ...
    if (!modalEl) {
        ...
        modalEl.innerHTML = ''
            ...
            + '      <img id="informativoImageModalImg" src="" alt="Imagem" class="img-fluid" style="max-height:85vh;object-fit:contain;">'
            + '    </div>'
            + '    <div class="modal-footer border-0 justify-content-end d-md-none">'
