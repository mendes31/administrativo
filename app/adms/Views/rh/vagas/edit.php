...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header">
            <i class="fas fa-briefcase me-2"></i>Editar Vaga de Emprego
        </div>
        <div class="card-body">
            ...
            <form method="POST" action="">
                ...
                <!-- Validação de ação sensível -->
                <div class="alert alert-warning">
                    <strong><i class="fas fa-exclamation-triangle me-1"></i>Atenção:</strong> Esta é uma ação sensível. Confirme sua senha e justifique a alteração.
                </div>
                <div class="row mb-3">
                    <div class="col-md-6 mb-2">
                ...
                <div class="mt-3 d-flex justify-content-end gap-2">
                    <a href="<?php echo $_ENV['URL_ADM']; ?>rh-vagas-view/<?= $this->data['form']['id'] ?? '' ?>" class="btn btn-secondary btn-sm">
