...
class LoadViewService
{
    ...
    public function loadView(): void
    {
        ...
        if (file_exists($this->view)) {
            ...
            file_put_contents(__DIR__ . '/../../../logs/filtro_global_debug.log', date('Y-m-d H:i:s') . ' - main.php executado em ' . ($_SERVER['REQUEST_URI'] ?? '') . ' user_id=' . ($_SESSION['user_id'] ?? 'null') . ' session_id=' . ($_SESSION['session_id'] ?? 'null') . PHP_EOL, FILE_APPEND);
