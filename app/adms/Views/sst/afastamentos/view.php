...
<div class="container-fluid px-4">
    ...
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3"><i class="fas fa-procedures me-2"></i><?= htmlspecialchars('Afastamento') ?> #<?= (int)$item['id'] ?></h2>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body d-flex flex-wrap gap-2 justify-content-between align-items-center">
            ...
            <div>
                <?php if (in_array('SstUpdateAfastamento', $perms)): ?><a href="<?= $_ENV['URL_ADM']; ?>sst-update-afastamento/<?= (int)$item['id'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Editar</a><?php endif; ?>
                <a href="<?= $_ENV['URL_ADM']; ?>sst-list-afastamentos" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left"></i> Voltar</a>
            </div>
        </div>
    </div>
    <div class="row">
...
<tr><th width="35%">Data fim:</th><td><?= formatCellValue('data_fim', $item['data_fim'] ?? null) ?></td></tr>
<tr><th width="35%">Dias:</th><td><?= formatCellValue('dias_afastamento', $item['dias_afastamento'] ?? null) ?></td></tr>
