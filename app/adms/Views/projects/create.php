    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_create_project'); ?>">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="pane-etapas" role="tabpanel" aria-labelledby="tab-etapas">
                        <p class="text-muted mb-0">
                            As etapas poderão ser configuradas após salvar o projeto, na tela de edição.
                        </p>
                    </div>
                </div>
