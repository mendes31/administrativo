...
<div class="canal-card">
    <div class="canal-header">
        ...
        <p class="text-muted">Preencha o formulário abaixo. A identificação é opcional — por padrão a denúncia permanece anônima.</p>
    </div>
    ...
    <form method="post" action="<?php echo htmlspecialchars($base_url . 'enviar', ENT_QUOTES, 'UTF-8'); ?>" enctype="multipart/form-data">
        ...
        <div class="mb-3 border rounded p-3 bg-light">
            ...
            <p class="small text-muted mb-2">Opcional. Seu contato será cifrado e visível apenas ao comitê responsável.</p>
            <div id="reporter-fields" class="<?php echo !empty($old['identify_reporter']) ? '' : 'd-none'; ?>">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="reporter_phone" class="form-control form-control-sm"
                            value="<?php echo htmlspecialchars((string)($old['reporter_phone'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
                    </div>
                </div>
                <div class="form-text">Informe e-mail ou telefone para contato.</div>
            </div>
        </div>
