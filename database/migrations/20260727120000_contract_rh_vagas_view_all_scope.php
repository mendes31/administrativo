...
/**
 * Contract Fase 0.5 — ativa filtro real de vagas (piloto).
 *
 * Mantém RhVagasViewAll apenas em níveis claramente de RH / Super Admin.
 * Demais níveis que tinham ViewAll (ex.: gestores) passam a ver só as vagas
 * em que são responsavel_id.
 *
 * Critério de manutenção (nome do nível de acesso, case-insensitive):
 * - Super Administrador / Super Admin
 * - Recursos Humanos / RH (palavra)
 * - Departamento Pessoal / DP (palavra)
 */
final class ContractRhVagasViewAllScope extends AbstractMigration
{
    public function up(): void
    {
        ...
        // Revoga ViewAll de níveis que NÃO são RH/Super.
        $this->execute(
    ...
    public function down(): void
    {
        ...
        // Restaura Expand: ViewAll para quem tem RhVagas.
        $this->execute(
