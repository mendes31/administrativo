...
final class RegisterListTrainingLntEventsPage extends AbstractMigration
{
    private const CONTROLLER = 'ListTrainingLntEvents';
    private const REF_CONTROLLER = 'ListTrainingStatus';
    ...
    public function up(): void
    {
        ...
        if (!$exists) {
            $this->table('adms_pages')->insert([
                ...
                'controller_url' => 'list-training-lnt-events',
                'directory' => 'trainings',
                'obs' => 'Registro de eventos de RH para apoio ao LNT: admissões, desligamentos, cargos novos e alterações.',
                'public_page' => 0,
                'default_page' => 0,
                'page_status' => 1,
