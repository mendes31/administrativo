...
final class GrantInvComplexityLevelFactorsPermissions extends AbstractMigration
{
    public function up(): void
    {
        ...
        $targets = $this->fetchAll(
            "SELECT id FROM adms_pages WHERE controller IN ('ListInvComplexityLevelFactors', 'SaveInvComplexityLevelFactors')"
        );
