...
final class CreateLgpdClassificacoesDados extends AbstractMigration
{
    public function up(): void
    {
        ...
        $table->addColumn('id', 'integer', ['identity' => true])
              ...
              // NOTA: Índice único não é criado aqui porque a coluna 'classificacao' é VARCHAR(255) 
              ...
              ->addIndex(['classificacao'], ['unique' => false, 'name' => 'idx_classificacao']) // Índice não-único para performance
