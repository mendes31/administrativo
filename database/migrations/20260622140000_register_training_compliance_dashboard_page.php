...
/**
 * Dashboard de Necessidades de Treinamento (visão agregada estilo LNT).
 */
final class RegisterTrainingComplianceDashboardPage extends AbstractMigration
{
    private const CONTROLLER = 'TrainingComplianceDashboard';
    private const REF_CONTROLLER = 'TrainingKpiDashboard';
    ...
    public function up(): void
    {
        ...
        if (!$exists) {
            $this->table('adms_pages')->insert([
                'name' => 'Dashboard de Necessidades de Treinamento',
                'controller' => self::CONTROLLER,
                'controller_url' => 'training-compliance-dashboard',
                'directory' => 'trainings',
                'obs' => 'Indicadores agregados de treinamentos vinculados e pendências por departamento, cargo e colaborador.',
                'public_page' => 0,
                'default_page' => 0,
                'page_status' => 1,
