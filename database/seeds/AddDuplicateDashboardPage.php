...
class AddDuplicateDashboardPage extends AbstractSeed
{
    public function run(): void
    {
        ...
        $existing = $this->fetchRow("SELECT id FROM adms_pages WHERE controller_url = 'duplicate-dashboard'");
        
        if ($existing) {
            echo "ℹ️  Página 'DuplicateDashboard' já existe (ID: {$existing['id']})\n";
            return;
        }
        ...
        $page = [
            ...
            'controller_url' => 'duplicate-dashboard',
            'directory' => 'dashboards',
            'obs' => 'Duplicar dashboard existente',
            'public_page' => 0,
            'page_status' => 1,
        ...
        echo "✅ Página 'DuplicateDashboard' adicionada com sucesso! (ID: {$pageId})\n";
    }
}
