...
class LoadPageAdm
{
    ...
    private array $listPgPrivate = [
        ...
        "Logout", 
        "ListAccessLevels", "CreateAccessLevel", "ViewAccessLevel", "UpdateAccessLevel", "DeleteAccessLevel", "ImportAccessLevels", "ExportAccessLevelPermissionsPdf",
    ...
    public function loadPageAdm(string|null $urlController, string|null $urlParameter): void
    {
        ...
        if (empty($routeParam)) {
            ...
            file_put_contents('C:/wamp64/www/administrativo/app/logs/session_debug2.log',
