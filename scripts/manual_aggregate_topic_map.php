...
function buildManualAggregateTopicMap(): array
{
    ...
    $add(['crm-dashboard', 'crm-manager-dashboard', 'crm-sales-dashboard', 'crm-sales-dashboard-data', 'crm-sales-dashboard-sync', 'crm-sales-carteira', 'crm-sales-vendedores', 'crm-sales-produtos'], 'crm-dashboards');
