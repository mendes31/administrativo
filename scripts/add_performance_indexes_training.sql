...
CREATE INDEX IF NOT EXISTS `idx_training_users_user_status` 
ON `adms_training_users` (`adms_user_id`, `status`);

CREATE INDEX IF NOT EXISTS `idx_training_users_training_status` 
ON `adms_training_users` (`adms_training_id`, `status`);

CREATE INDEX IF NOT EXISTS `idx_training_users_created_at` 
ON `adms_training_users` (`created_at`);

-- Índices para adms_training_applications
-- Melhora busca de última aplicação (resolve N+1)
CREATE INDEX IF NOT EXISTS `idx_training_applications_user_training_created` 
ON `adms_training_applications` (`adms_user_id`, `adms_training_id`, `created_at` DESC);

CREATE INDEX IF NOT EXISTS `idx_training_applications_user_training` 
